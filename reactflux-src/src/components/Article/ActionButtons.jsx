...
const DesktopButtons = memo(
  ({ commonButtons, hasIntegrations, handleSaveToThirdPartyServices, polyglot, aiButton }) => (
    <>
...
const MobileButtons = memo(({ commonButtons, hasHeadings, aiButton }) => (
...
const ActionButtons = ({ articleAI: articleAIProp }) => {
  ...
  const commonButtons = {
    ...
    translate: isAIConfigured ? (
      <CustomTooltip
        mini
        content={
          isTranslating
            ? polyglot.t("ai.translating")
            : showTranslation
              ? polyglot.t("ai.show_original")
              : polyglot.t("ai.translate")
        }
      >
        <Button
          icon={<IconLanguage />}
          ...
          type={showTranslation ? "primary" : "secondary"}
    ...
    <div className={`action-buttons ${isBelowMedium ? "mobile" : ""}`}>
      {isBelowMedium ? (
        <MobileButtons
          ...
          aiButton={commonButtons.translate}
        />
      ) : (
        <DesktopButtons
          commonButtons={commonButtons}
